...
import { openMapInBrowser } from '../Components/openMap'; // <── НОВОЕ
...
export default function LocationDetails() {
  ...
  const onOpenMap = () => {
    openMapInBrowser(spot.coords.lat, spot.coords.lon, spot.name);
  };
            ...
            <View style={styles.inlineBtns}>
              ...
              >
                <Image
                  ...
                  style={[
                    styles.squareIcon,
                    isSaved && styles.squareIconActive,
                  ]}
                />
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  squareIconActive:{ tintColor: '#FFFFFF' },
